              ...
              <div class="card-body">
                <form method="POST" action="<?php echo base_url('pengajuan/process') ?>" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="universitas / Sekolah" placeholder="e.g. Universitas / Sekolah">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="semester">
                      <option value="">Pilih Semester / Kelas</option>
                        <?php for ($i=1; $i < 9; $i++){
                  ...
                  <div class="form-group">
                    <label>Alamat</label>
                    <textarea class="form-control" name="alamat" placeholder="e.g. Cibinong"></textarea>
