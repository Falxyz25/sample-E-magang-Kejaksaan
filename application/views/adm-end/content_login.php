...
<head>
  ...
  <link rel="icon" href="<?= base_url('include/img/Kejaksaan_Agung_Republik_Indonesia_new_logo (2).png') ?>">
...
<body class="hold-transition login-page" style="background:url(../include/img/photo4.png)
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
		      <b><center><h4>E-Magang | Administrator</h4></center></b>
		<br>
